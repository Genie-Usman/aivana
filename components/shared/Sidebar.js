...
const MotionLink = ({ link, isActive }) => (
  <motion.li variants={itemVariants}>
    <CustomLink href={link.route}>
      <motion.div
        className={`flex items-center gap-4 px-4 py-3 rounded-3xl font-medium text-[16px] transition-colors duration-300 ${
          isActive
      ...
      >
        <Image
          ...
          width={24}
          height={24}
          className="w-6 h-6 min-w-[24px] min-h-[24px] transition-all"
        />
